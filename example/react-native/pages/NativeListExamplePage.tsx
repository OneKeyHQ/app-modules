...
const networkImages = {
  ...
  Dogecoin: image('https://uni.onekey-asset.com/static/chain/doge.png', 32, 32),
  'Bitcoin Cash': image(
    'https://uni.onekey-asset.com/static/chain/bch.png',
    32,
    32,
  ),
  Litecoin: image('https://uni.onekey-asset.com/static/chain/ltc.png', 32, 32),
  Neurai: image('https://uni.onekey-asset.com/static/chain/neurai.png', 32, 32),
  ...
  opBNB: image('https://uni.onekey-asset.com/static/chain/opbnb.png', 32, 32),
  'X Layer': image('https://uni.onekey-asset.com/static/chain/okb.png', 32, 32),
  Taiko: image('https://uni.onekey-asset.com/static/chain/taiko.png', 32, 32),
  Scroll: image('https://uni.onekey-asset.com/static/chain/scr.png', 32, 32),
  Ronin: image('https://uni.onekey-asset.com/static/chain/ronin.png', 32, 32),
  PulseChain: image(
  ...
  Kava: image('https://uni.onekey-asset.com/static/chain/kava.png', 32, 32),
  IoTeX: image('https://uni.onekey-asset.com/static/chain/iotex.png', 32, 32),
  Flare: image('https://uni.onekey-asset.com/static/chain/flare.png', 32, 32),
  'Filecoin FEVM': image(
  ...
  'Ethereum Classic': image(
    'https://uni.onekey-asset.com/static/chain/etc.png',
    32,
    32,
  ),
  Endurance: image('https://uni.onekey-asset.com/static/chain/ace.png', 32, 32),
  Cyber: image('https://uni.onekey-asset.com/static/chain/cyeth.png', 32, 32),
  Cronos: image('https://uni.onekey-asset.com/static/chain/cronos.png', 32, 32),
  'Conflux eSpace': image(
    'https://uni.onekey-asset.com/static/chain/conflux-espace.png',
    32,
    32,
  ),
  Boba: image('https://uni.onekey-asset.com/static/chain/boba.png', 32, 32),
  ...
  'Secret Network': image(
    'https://uni.onekey-asset.com/static/chain/secret.png',
    32,
    32,
  ),
  Juno: image('https://uni.onekey-asset.com/static/chain/juno.png', 32, 32),
  'Fetch.ai': image(
    'https://uni.onekey-asset.com/static/chain/fetch.png',
    32,
    32,
  ),
  'Cronos POS Chain': image(
    'https://uni.onekey-asset.com/static/chain/cryptoorg.png',
    32,
    32,
  ),
  Akash: image('https://uni.onekey-asset.com/static/chain/akash.png', 32, 32),
  Osmosis: image(
    'https://uni.onekey-asset.com/static/chain/osmosis.png',
    32,
    32,
  ),
  Cosmos: image('https://uni.onekey-asset.com/static/chain/cosmos.png', 32, 32),
  'Babylon Genesis': image(
    'https://uni.onekey-asset.com/static/logo/babylon.png',
    32,
    32,
  ),
  Noble: image('https://uni.onekey-asset.com/static/chain/noble.png', 32, 32),
  Astar: image('https://uni.onekey-asset.com/static/chain/astar.png', 32, 32),
  'Manta Atlantic': image(
    'https://uni.onekey-asset.com/static/chain/manta-atlantic.png',
    32,
    32,
  ),
  Hydration: image('https://uni.onekey-asset.com/static/chain/hdx.png', 32, 32),
  'Bifrost Kusama': image(
    'https://uni.onekey-asset.com/static/chain/bnc.png',
    32,
    32,
  ),
  'Bifrost Polkadot': image(
    'https://uni.onekey-asset.com/static/chain/bifrost.png',
    32,
    32,
  ),
  'Polkadot AssetHub': image(
    'https://uni.onekey-asset.com/static/chain/dot-assethub.png',
    32,
    32,
  ),
  'Kusama AssetHub': image(
    'https://uni.onekey-asset.com/static/chain/dot-ksm-assethub.png',
    32,
    32,
  ),
  Aptos: image('https://uni.onekey-asset.com/static/chain/apt.png', 32, 32),
  'Lightning Network': image(
    'https://uni.onekey-asset.com/static/chain/lnd.png',
    32,
    32,
  ),
  Cardano: image('https://uni.onekey-asset.com/static/chain/ada.png', 32, 32),
  'XRP Ledger': image(
    'https://uni.onekey-asset.com/static/chain/xrp.png',
    32,
    32,
  ),
  Nostr: image('https://uni.onekey-asset.com/static/chain/nostr.png', 32, 32),
  Near: image('https://uni.onekey-asset.com/static/chain/near.png', 32, 32),
  Tron: image('https://uni.onekey-asset.com/static/chain/tron.png', 32, 32),
  Conflux: image('https://uni.onekey-asset.com/static/chain/cfx.png', 32, 32),
  Solana: image('https://uni.onekey-asset.com/static/chain/sol.png', 32, 32),
  Nexa: image('https://uni.onekey-asset.com/static/chain/nexa.png', 32, 32),
  Kaspa: image('https://uni.onekey-asset.com/static/chain/kas.png', 32, 32),
  Filecoin: image('https://uni.onekey-asset.com/static/chain/fil.png', 32, 32),
  Algorand: image('https://uni.onekey-asset.com/static/chain/algo.png', 32, 32),
  SUI: image('https://uni.onekey-asset.com/static/chain/sui.png', 32, 32),
  Nervos: image('https://uni.onekey-asset.com/static/chain/nervos.png', 32, 32),
  TON: image('https://uni.onekey-asset.com/static/chain/ton.png', 32, 32),
  BenFen: image('https://uni.onekey-asset.com/static/chain/bfc.png', 32, 32),
  Stellar: image(
    'https://uni.onekey-asset.com/static/chain/stellar.png',
    32,
    32,
  ),
  Fantom: image('https://uni.onekey-asset.com/static/chain/fantom.png', 32, 32),
  Celo: image('https://uni.onekey-asset.com/static/chain/celo.png', 32, 32),
  'Rootstock Mainnet': image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1741759929148.0.8278256578069925.0.png',
    32,
    32,
  ),
  'InitVerse Mainnet': image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1749437735301.0.9780950009234293.0.jpg',
    32,
    32,
  ),
  Berachain: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1743478980982.0.3723704755020256.0.png',
    32,
    32,
  ),
  'zkLink Nova': image(
    'https://uni.onekey-asset.com/static/chain/zklinknova.png',
    32,
    32,
  ),
  Zora: image('https://uni.onekey-asset.com/static/chain/zora.png', 32, 32),
  Zircuit: image(
    'https://uni.onekey-asset.com/static/chain/zircuit.png',
    32,
    32,
  ),
  ZetaChain: image(
    'https://uni.onekey-asset.com/static/chain/zetachain.png',
    32,
    32,
  ),
  'Xphere Mainnet': image(
  ...
  'WEMIX3.0': image(
    'https://uni.onekey-asset.com/static/chain/wemix.png',
    32,
    32,
  ),
  Stable: image(
  ...
  Pharos: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1770285036634.0.5900647465698633.0.png',
    32,
    32,
  ),
  Mova: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1781275358771.0.9383792401812865.0.jpg',
    32,
    32,
  ),
  Moonbeam: image(
    'https://uni.onekey-asset.com/static/chain/moonbeam.png',
    32,
    32,
  ),
  Monad: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1763955470589.0.6144637200985958.0.png',
    32,
    32,
  ),
  Mode: image('https://uni.onekey-asset.com/static/chain/mode.png', 32, 32),
  Metis: image('https://uni.onekey-asset.com/static/chain/metis.png', 32, 32),
  MegaETH: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1770255873008.0.42268410725486827.0.png',
    32,
    32,
  ),
  Kaia: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1731660695728.0.27070669082665355.0.png',
    32,
    32,
  ),
  Harmony: image(
    'https://uni.onekey-asset.com/static/chain/harmony.png',
    32,
    32,
  ),
  Dymension: image(
    'https://uni.onekey-asset.com/static/chain/dymension.png',
    32,
    32,
  ),
  Core: image('https://uni.onekey-asset.com/static/chain/core.png', 32, 32),
  BounceBit: image(
    'https://uni.onekey-asset.com/static/chain/bouncebit.png',
    32,
    32,
  ),
  'BirdLayer mainnet': image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1753770054421.0.2510982282836258.0.png',
    32,
    32,
  ),
  APChain: image(
    'https://uni-test.onekey-asset.com/dashboard/logo/upload_1776661892884.0.49840198804394775.0.png',
    32,
    32,
  ),
} as const;
...
function sectionedNetworkRows(
  ...
  return [
    ...(includeListHeader ? [networkSummaryHeader(selectedCount, 113)] : []),
    {
      type: 'sectionHeader',
    ...
    networkIdentity({
      key: 'network-babylon-genesis',
      name: 'Babylon Genesis',
      sectionKey: 'b',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-bifrost-kusama',
      name: 'Bifrost Kusama',
      sectionKey: 'b',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-bifrost-polkadot',
    ...
    networkIdentity({
      key: 'network-berachain',
      name: 'Berachain',
      sectionKey: 'b',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-bouncebit',
      name: 'BounceBit',
      sectionKey: 'b',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-birdlayer-mainnet',
    ...
    networkIdentity({
      key: 'network-conflux-espace',
      name: 'Conflux eSpace',
      sectionKey: 'c',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-celestia',
      name: 'Celestia',
      sectionKey: 'c',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-cronos-pos-chain',
    ...
    networkIdentity({
      key: 'network-datatradechain',
      name: 'DataTradeChain',
      sectionKey: 'd',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-dymension',
      name: 'Dymension',
      sectionKey: 'd',
      groupPosition: 'last',
    }),
    {
      type: 'sectionHeader',
      key: 'network-e-header',
      sectionKey: 'e',
      indexTitle: 'E',
      title: 'E',
    },
    networkIdentity({
      key: 'network-ethereumpow',
      name: 'EthereumPoW',
      sectionKey: 'e',
      groupPosition: 'first',
    }),
    networkIdentity({
      key: 'network-ethereum-classic',
      name: 'Ethereum Classic',
      sectionKey: 'e',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-endurance',
      name: 'Endurance',
      sectionKey: 'e',
      groupPosition: 'last',
    }),
    ...
    networkIdentity({
      key: 'network-filecoin-fevm',
      name: 'Filecoin FEVM',
      sectionKey: 'f',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-fetch-ai',
      name: 'Fetch.ai',
      sectionKey: 'f',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-filecoin',
      name: 'Filecoin',
      sectionKey: 'f',
      groupPosition: 'middle',
    }),
    ...
    {
      type: 'sectionHeader',
      key: 'network-h-header',
      sectionKey: 'h',
      indexTitle: 'H',
      title: 'H',
    },
    networkIdentity({
      key: 'network-hashkey-chain',
      name: 'HashKey Chain',
      sectionKey: 'h',
      groupPosition: 'first',
    }),
    networkIdentity({
      key: 'network-hyperevm',
      name: 'HyperEVM',
      sectionKey: 'h',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-hydration',
      name: 'Hydration',
      sectionKey: 'h',
      groupPosition: 'middle',
    }),
    ...
    networkIdentity({
      key: 'network-manta-pacific',
      name: 'Manta Pacific',
      sectionKey: 'm',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-manta-atlantic',
      name: 'Manta Atlantic',
      sectionKey: 'm',
      groupPosition: 'middle',
    }),
    ...
    networkIdentity({
      key: 'network-rootstock-mainnet',
      name: 'Rootstock Mainnet',
      sectionKey: 'r',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-robinhood',
      name: 'Robinhood',
      sectionKey: 'r',
      groupPosition: 'last',
    }),
    ...
    {
      type: 'sectionHeader',
      key: 'network-w-header',
      sectionKey: 'w',
      indexTitle: 'W',
      title: 'W',
    },
    networkIdentity({
      key: 'network-world-chain',
      name: 'World Chain',
      sectionKey: 'w',
      groupPosition: 'first',
    }),
    networkIdentity({
      key: 'network-wemix3-0',
      name: 'WEMIX3.0',
      sectionKey: 'w',
      groupPosition: 'last',
    }),
    ...
    networkIdentity({
      key: 'network-xrp-ledger',
      name: 'XRP Ledger',
      sectionKey: 'x',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-xphere-mainnet',
      name: 'Xphere Mainnet',
      sectionKey: 'x',
      groupPosition: 'middle',
    }),
    networkIdentity({
      key: 'network-xdc-network',
      name: 'XDC Network',
      sectionKey: 'x',
      groupPosition: 'last',
    }),
    {
      type: 'sectionHeader',
      key: 'network-z-header',
      sectionKey: 'z',
      indexTitle: 'Z',
      title: 'Z',
    },
    networkIdentity({
      key: 'network-zksync-era',
      name: 'zkSync Era',
      sectionKey: 'z',
      groupPosition: 'first',
    }),
    networkIdentity({
      key: 'network-zklink-nova',
      name: 'zkLink Nova',
      sectionKey: 'z',
      groupPosition: 'middle',
    }),
...
function sectionHeaderPreviewRows(): readonly RowModel[] {
  return [
    {
      type: 'sectionHeader',
      key: 'network-assets-header',
...
const actionRows: readonly RowModel[] = [
  ...
  },
  {
    ...
    title: 'Tokens',
    style: {
      container: { height: 30, contentVerticalAlignment: 'bottom' },
      horizontalPadding: 12,
      verticalPadding: 0,
      title: { fontSize: 14, lineHeight: 20, fontWeight: 'regular' },
    },
  },
  ...tokenManagerRows,
