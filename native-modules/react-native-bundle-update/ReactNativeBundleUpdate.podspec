...
Pod::Spec.new do |s|
  ...
  # When ONEKEY_ALLOW_SKIP_GPG_VERIFICATION env var is set (and not 'false'),
  ...
  if ENV['ONEKEY_ALLOW_SKIP_GPG_VERIFICATION'] && ENV['ONEKEY_ALLOW_SKIP_GPG_VERIFICATION'] != 'false'
