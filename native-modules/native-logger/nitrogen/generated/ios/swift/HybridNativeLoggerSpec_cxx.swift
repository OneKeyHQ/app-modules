...
open class HybridNativeLoggerSpec_cxx {
   ...
   * The pointer has to be a retained opaque `Unmanaged<HybridNativeLoggerSpec_cxx>`.
   * This removes one strong reference from the object!
   */
  public class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridNativeLoggerSpec_cxx {
    return Unmanaged<HybridNativeLoggerSpec_cxx>.fromOpaque(pointer).takeRetainedValue()
  }

  /**
   * Gets (or creates) the C++ part of this Hybrid Object.
   * The C++ part is a `std::shared_ptr<HybridNativeLoggerSpec>`.
   */
