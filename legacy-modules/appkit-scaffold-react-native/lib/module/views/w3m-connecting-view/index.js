...
import { AccountController, ConnectionController, ConstantsUtil, CoreHelperUtil, ModalController, RouterController, SnackController, OptionsController, ApiController, EventsController, ConnectorController } from '@reown/appkit-core-react-native';
...
export function ConnectingView() {
  ...
  const platformTemplate = () => {
    if (isQr) {
      return /*#__PURE__*/React.createElement(ConnectingQrCode, null);
    }
    switch (platform) {
      case 'mobile':
