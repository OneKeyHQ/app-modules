...
import { AccountController, ApiController, ConnectionController, ConnectorController, CoreHelperUtil, EventsController, ModalController, OptionsController, RouterController, TransactionsController, ThemeController } from '@reown/appkit-core-react-native';
...
export function AppKit() {
  ...
  const handleClose = async () => {
    ...
    if (RouterController.state.view === 'OnRampLoading' && EventsController.state.data.event === 'BUY_SUBMITTED') {
  ...
  const onNewAddress = useCallback(async address => {
  ...
  }, /*#__PURE__*/React.createElement(Header, null), /*#__PURE__*/React.createElement(AppKitRouter, null), /*#__PURE__*/React.createElement(Snackbar, null))), !!showAuth && AuthView && /*#__PURE__*/React.createElement(AuthView, null), !!showAuth && SocialView && /*#__PURE__*/React.createElement(SocialView, null)));
}
