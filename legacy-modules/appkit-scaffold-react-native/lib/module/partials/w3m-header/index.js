...
import { RouterController, ModalController, EventsController, ConnectionController, ConnectorController } from '@reown/appkit-core-react-native';
...
export function Header() {
  ...
  const headings = (_data, _view) => {
    ...
    const socialName = ConnectionController.state.selectedSocialProvider ? StringUtil.capitalize(ConnectionController.state.selectedSocialProvider) : undefined;
    return {
      Account: undefined,
  ...
  const checkSocial = () => {
    if (RouterController.state.view === 'ConnectingFarcaster' || RouterController.state.view === 'ConnectingSocial') {
  ...
  return /*#__PURE__*/React.createElement(FlexView, {
    ...
    numberOfLines: 1,
    testID: "header-text"
  }, header), showClose ? /*#__PURE__*/React.createElement(IconLink, {
    icon: "close",
    size: "md",
    onPress: handleClose,
    testID: "header-close"
