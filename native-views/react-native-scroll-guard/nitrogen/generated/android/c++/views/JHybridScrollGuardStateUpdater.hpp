...
#error scrollguard was compiled without the 'RN_SERIALIZABLE_STATE' flag. This flag is required for Nitro Views - set it in your CMakeLists!
#endif
...
public:
  static void updateViewProps(jni::alias_ref<jni::JClass> /* class */,
                              jni::alias_ref<JHybridScrollGuardSpec::javaobject> view,
...
public:
  static void registerNatives() {
    ...
    javaClassStatic()->registerNatives({
      makeNativeMethod("updateViewProps", JHybridScrollGuardStateUpdater::updateViewProps),
    });
    // Register React Native view component descriptor
    auto provider = react::concreteComponentDescriptorProvider<HybridScrollGuardComponentDescriptor>();
