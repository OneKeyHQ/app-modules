...
/**
 * Wraps a Swift `(_ key: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.tabview.bridge.swift

  private let closure: (_ key: String) -> Void

  public init(_ closure: @escaping (_ key: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(key: std.string) -> Void {
    self.closure(String(key))
  }
