...
final class NativeListView: UIView {
  ...
  override init(frame: CGRect) {
    ...
    NSLayoutConstraint.activate([
      ...
      sectionIndexView.topAnchor.constraint(equalTo: collectionView.safeAreaLayoutGuide.topAnchor),
      sectionIndexView.bottomAnchor.constraint(equalTo: collectionView.safeAreaLayoutGuide.bottomAnchor),
