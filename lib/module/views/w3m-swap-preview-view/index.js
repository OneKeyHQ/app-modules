...
import { Button, FlexView, Icon, Spacing, Text, TokenButton, UiUtil } from '@reown/appkit-ui-react-native';
...
export function SwapPreviewView() {
  ...
  const sourceTokenMarketValue = NumberUtil.parseLocalStringToNumber(sourceTokenAmount) * sourceTokenPriceInUSD;
  ...
  return /*#__PURE__*/React.createElement(ScrollView, {
    ...
    color: "fg-100"
  }, "$", UiUtil.formatNumberToLocalString(sourceTokenMarketValue, 2))), /*#__PURE__*/React.createElement(TokenButton, {
    ...
    variant: "small-400",
    color: "fg-150"
  }, "Receive"), /*#__PURE__*/React.createElement(Text, {
    variant: "paragraph-400",
    color: "fg-100"
  }, "$", UiUtil.formatNumberToLocalString(toTokenMarketValue, 2))), /*#__PURE__*/React.createElement(TokenButton, {
    text: ` ${toTokenAmount} ${toToken?.symbol}`,
    imageUrl: toToken?.logoUri,
    inverse: true,
    disabled: true
  })), /*#__PURE__*/React.createElement(SwapDetails, {
    initialOpen: true,
    canClose: false
  }), /*#__PURE__*/React.createElement(FlexView, {
    flexDirection: "row",
