import { AssetUtil, ConnectionController, StorageUtil } from '@reown/appkit-core-react-native';
import { LayoutAnimation, Platform } from 'react-native';
export const UiUtil = {
  TOTAL_VISIBLE_WALLETS: 4,
  createViewTransition: () => {
    const IS_IOS_NEW_ARCH = Platform.OS === 'ios' && global?.nativeFabricUIManager != null;
