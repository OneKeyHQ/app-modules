...
### Chores
- Add the "Native List Row Style" example page with plain/styled pairs for all 12 row types, plus list chrome and explicit-height examples. Variant coverage and native visual acceptance remain pending; see `docs/STYLE_SPEC.md`.
