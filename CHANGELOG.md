...
- **native-list (Web)**: Keep the default cursor on wallet sidebar, hardware wallet group member, account, and Add account rows, and round the Add account row's hover and pressed backgrounds with the 12px account row radius.
