...
### Chores
- Add the "Native List Row Style" example page with plain/styled pairs for identity, metricCard, message, rail and action, plus list chrome and explicit-height examples. Full template/variant coverage and native visual acceptance remain pending; see `docs/STYLE_SPEC.md`.
